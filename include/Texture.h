 ...
 * @brief TODO
 *
 * @note Size: 0x3C (0x34 in the DOL).
 */
...
public:
	...
	u32 mLODCount;     // _18
	f32 mLODBias;      // _1C
	u32 mAttachName;   // _20, -1 if detached, 0 if attached
...
#else
	u32 mAttachName;   // _18, -1 if detached, a unique value generated by `glGenTextures` if attached
	f32 mWidthFactor;  // _1C, 1.0f / width
	f32 mHeightFactor; // _20, 1.0f / height
	u32 mLODCount;     // _24
	f32 mLODBias;      // _28
	u32 _30;           // _2C, might instead be the member `_34`, it's impossible to say.
	TexobjInfo* mInfo; // _30
	GXTexObj* mTexObj; // Definitely was removed.  Fully remove once we stop compiling DGXGraphics.cpp for DLL
#endif
};
